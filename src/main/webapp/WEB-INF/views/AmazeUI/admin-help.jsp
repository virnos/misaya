  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      <div class="am-u-sm-12 am-u-sm-centered">
        <h2>${mainHeading } 1.0.0 Beta</h2>
        <p>对于 ${mainHeading }，我们不是创造者。</p>
        <p>${mainHeading } 的诞生，依托于 GitHub 及其他技术社区上一些优秀的资源；${mainHeading } 的成长，则离不开用户的支持。</p>
        <p>感谢开源！感谢有你！</p>
        <hr/>
      </div>
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <h3>Bug 反馈</h3>
        <p>感谢对 ${mainHeading } 的关注和支持，如遇到 Bug 或者使用问题，可以通过以下途径反馈给我们：</p>
        <ol>
        ...
        <p>下面的几个链接是我们在几个在线调试工具上建的页面， 已经引入了 ${mainHeading } 样式和脚本，你可以选择你喜欢的工具【Fork】一份， 把要有问题的场景粘在里面，反馈给我们。</p>
        <ol>
