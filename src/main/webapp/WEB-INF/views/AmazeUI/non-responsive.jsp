...
<head lang="en">
  ...
  <link rel="alternate icon" type="image/png" href="${resourcesPath }assets/i/favicon.png">
...
<div class="get">
  <div class="am-container">
    <h1 class="get-title">${mainHeading } - HTML5 跨屏前端框架</h1>
  ...
  <div class="am-container">
    ...
    <div class="am-g">
      <div class="am-u-sm-3 detail-mb">
        ...
        <p class="detail-p">
          ${mainHeading } 采用业内先进的 mobile first 理念，从小屏逐步扩展到大屏，最终实现所有屏幕适配，适应移动互联潮流。
        </p>
      </div>
      <div class="am-u-sm-3 detail-mb">
        <h3 class="detail-h3">
        ...
        <p class="detail-p">
          ${mainHeading } 含近 20 个 CSS 组件、10 个 JS 组件，更有 17 款包含近 60 个主题的 Widgets，可快速构建界面出色、体验优秀的跨屏页面，大幅度提升你的开发效率。
        </p>
      </div>
      <div class="am-u-sm-3 detail-mb">
        <h3 class="detail-h3">
        ...
        <p class="detail-p">
          相比国外的前端框架，${mainHeading } 专注解决中文排版优化问题，根据操作系统调整字体，实现最佳中文排版效果；针对国内主流浏览器及 App 内置浏览器提供更好的兼容性支持，为你节省大量兼容性调试时间。
        </p>
      </div>
      <div class="am-u-sm-3 detail-mb">
        <h3 class="detail-h3">
        ...
        <p class="detail-p">
          ${mainHeading } 非常注重性能，基于轻量的 Zepto.js 开发，并使用 CSS3 来做动画交互，平滑、高效，更适合移动设备，让你的 Web 应用可以高速载入。
        </p>
      </div>
    </div>
  </div>
...
<div class="hope">
  <div class="am-g am-container">
    <div class="am-u-sm-6 hope-img">
      <img src="${resourcesPath }assets/i/examples/landing.png" alt="" data-am-scrollspy="{animation:'slide-left', repeat: false}">
    ...
    <div class="am-u-sm-6">
      ...
      <p>
        在知识爆炸的年代，我们不愿成为知识的过客，拥抱开源文化，发挥社区的力量，参与到${mainHeading }开源项目能获得自我提升。
      </p>
    </div>
  </div>
</div>
...
<div class="about">
  <div class="am-container">
    <h2 class="about-title about-color">${mainHeading } 崇尚开放、自由，非常欢迎大家的参与</h2>
...
<footer class="footer">
  <div class="am-container">
    <p>© 2015 <a href="http://www.yunshipei.com" target="_blank">AllMobilize, Inc.</a> Licensed under <a
