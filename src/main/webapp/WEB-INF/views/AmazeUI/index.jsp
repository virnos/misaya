...
<head>
  ...
  <link rel="icon" sizes="192x192" href="${resourcesPath }assets/i/app-icon72x72@2x.png">
  ...
  <meta name="msapplication-TileImage" content="${resourcesPath }assets/i/app-icon72x72@2x.png">
  ...
  <link rel="stylesheet" href="${resourcesPath }assets/css/app.css">
</head>
<body>
<!--[if lte IE 9]>
<p class="browsehappy">你正在使用<strong>过时</strong>的浏览器，${mainHeading } 暂不支持。 请 <a
...
<div class="am-g am-g-fixed am-margin-top">
  <div class="am-u-sm-12">
    <h1>你好世界！小可 ${mainHeading } 模板。</h1>

    <p>这是一个基础的页面，引入 ${mainHeading } 的 css 、js
  ...
  <div class="am-u-sm-12">
    <div class="am-g">
      <div class="am-u-sm-12 am-u-md-3">
        <a href="landing"><img class="am-img-thumbnail"
                                    src="${resourcesPath }assets/i/examples/landingPage.png"
                                    alt="展示页面"/></a>
      </div>
    ...
    <div class="am-g am-margin-top">
      <div class="am-u-sm-12 am-u-md-3">
        <a href="login"><img class="am-img-thumbnail"
                                  src="${resourcesPath }assets/i/examples/loginPage.png"
                                  alt="登录页面"/></a>
      </div>
      <div class="am-u-sm-12 am-u-md-9">
        <h3>登录页面</h3>
    ...
    <div class="am-g am-margin-top">
      <div class="am-u-sm-12 am-u-md-3">
        <a href="blog"><img class="am-img-thumbnail"
                                 src="${resourcesPath }assets/i/examples/blogPage.png"
                                 alt="博客页面"/></a>
      </div>
      <div class="am-u-sm-12 am-u-md-9">
        <h3>博客页面</h3>
    ...
    <div class="am-g am-margin-top">
      <div class="am-u-sm-12 am-u-md-3">
        <a href="sidebar"><img class="am-img-thumbnail"
                                    src="${resourcesPath }assets/i/examples/sidebarPage.png"
                                    alt="博客侧栏页面"/></a>
      </div>
      <div class="am-u-sm-12 am-u-md-9">
        <h3>博客侧栏页面</h3>
    ...
    <h2>Web 组件示例</h2>
    <ul>
      <li><a href="widget.basic">widget.basic</a> 使用了 <a
        href="http://amazeui.org/widgets.html">Web 组件</a> 的 HTML 结构和样式，但没用使用模板在前端渲染数据，供通过后端渲染数据的用户参考。</li>
      <li><a href="widget">widget</a> 是 Web 组件的展示，更多细节查看：<a
        href="http://amazeui.org/widgets.html">Web 组件</a></li>
    </ul>
    <h3>开始创建你的网页吧。</h3>
  </div>
</div>
